...
/** Shopier requires image URLs to end with a file extension (no ?query only). */
const DEFAULT_PRODUCT_IMAGE =
  'https://images.unsplash.com/photo-1518199266791-5375a32590dc.jpg';

const SHOPIER_IMAGE_URL_REGEX =
  /^https?:\/\/.*\.(jpg|jpeg|png|tiff|tif|webp)$/i;

function sanitizeShopierImageUrl(url) {
...
function getConfig() {
  return {
    ...
    productImageUrl: sanitizeShopierImageUrl(process.env.SHOPIER_PRODUCT_IMAGE_URL),
  };
}
